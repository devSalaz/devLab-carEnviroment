...
class CustomPaintPhysicalMaterial extends THREE.MeshPhysicalMaterial {
  constructor(args) {
    super(args);

    this.uniforms = {
      uValueZ: { value: 7.0 },
      uColor1: { value: new THREE.Color("salmon") },
...
extend({ PaintCustomMaterial: CustomPaintPhysicalMaterial });

export default forwardRef(function MeshPaintCustomMaterial(props, ref) {
  return <paintCustomMaterial ref={ref} {...props} />;
});
